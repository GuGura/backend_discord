...
public class CorsConfig implements WebMvcConfigurer {
    ...
    public CorsFilter corsFilter(){
        ...
        config.setAllowedOriginPatterns(Arrays.asList("http://*.meatteam.online", "http://localhost:3000","http://localhost:3000/channel/*","http://192.168.130.65:3000","http://192.168.130.65:3000/channl/*"));
